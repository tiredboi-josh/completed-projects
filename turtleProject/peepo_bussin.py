 # joshua planck
# module 10 exercise 5-2
# assignment
# use turtle have object be moved by arrow keys
# use functions for movement
# can use
# turtle.shape() uses gif files
# turtle.bgpic() uses png files
...
import turtle
import time
#from playsound import playsound   #this module is only needed when you want to play audio during the running program
...
#def playmusic():
#    playsound('bootyful music.mp3', block = False) # setting block make playsound play asynchronously
#    wn.ontimer(playmusic, 131400) # plays on loop custum lenth on the .mp3 file if you want to change the .mp3 file this needs to be changed aswell
#playmusic()
...
peepo_right_animation()


# user controls

wn.onkey(peepo_left_animation , "Left")
